...
namespace Gaia.WebWidgets
{
    ...
    /// <summary>
    /// Specialized <see cref="Stream"/> used in the <see cref="HttpResponse.Filter"/> chain.
    /// </summary>
    internal sealed class HttpResponseFilter : Stream
    {
        ...
        /// </summary>
        /// <param name="sink">Chained <see cref="Stream"/> to wrap.</param>
        ...
        protected override void Dispose(bool disposing)
        {
            try
            {
                if (disposing)
                {
                    ...
                    string pageContent;
                    _buffer.Position = 0;
                    using(var streamReader = new StreamReader(_buffer))
                        pageContent = streamReader.ReadToEnd();

                    var responseText = Manager.Instance.ProcessPage(pageContent);
                    using(var streamWriter = new StreamWriter(_sink))
