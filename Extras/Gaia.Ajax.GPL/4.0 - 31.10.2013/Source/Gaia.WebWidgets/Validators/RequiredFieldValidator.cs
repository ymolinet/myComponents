...
namespace Gaia.WebWidgets
{
    ...
    /// </summary>
    [ToolboxBitmap(typeof(RequiredFieldValidator), "Resources.Gaia.WebWidgets.RequiredFieldValidator.bmp")]
    public class RequiredFieldValidator : ASP.RequiredFieldValidator, IAjaxControl, IAjaxValidator
    {
        /// <summary>
        /// Specialized <see cref="PropertyStateManagerControl"/> for <see cref="RequiredFieldValidator"/> control.
        /// </summary>
        public class PropertyStateManagerRequiredFieldValidator : PropertyStateManagerBaseValidator
        {
            private string _initialValue;
            private readonly RequiredFieldValidator _owner;
            ...
            public PropertyStateManagerRequiredFieldValidator(RequiredFieldValidator validator) : base(validator.BaseValidator)
            {
                _owner = validator;
            }
            ...
            {
                get { return base.RequiresRerendering || ValueHasChanged(_initialValue, _owner.InitialValue); }
            }
            ...
            protected override void AssignState(PropertyStateManagerControl source)
            {
                ...
                var stateManager = source as PropertyStateManagerRequiredFieldValidator;
                if (stateManager == null) return;

                _initialValue = stateManager._initialValue;
            }
            ...
            {
                _initialValue = _owner.InitialValue;
                base.TakeSnapshot();
            }
        }
        ...
        {
            return new PropertyStateManagerRequiredFieldValidator(this);
        }
