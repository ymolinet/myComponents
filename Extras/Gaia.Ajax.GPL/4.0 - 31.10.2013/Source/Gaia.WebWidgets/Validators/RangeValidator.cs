...
namespace Gaia.WebWidgets
{
    ...
    /// </summary>
    [ToolboxBitmap(typeof(RangeValidator), "Resources.Gaia.WebWidgets.RangeValidator.bmp")]
    public class RangeValidator : ASP.RangeValidator, IAjaxControl, IAjaxValidator
    {
        /// <summary>
        /// Specialized <see cref="PropertyStateManagerControl"/> for <see cref="RangeValidator"/> control.
        /// </summary>
        public class PropertyStateManagerRangeValidator : PropertyStateManagerBaseCompareValidator
        {
            private string _min;
            private string _max;

            private readonly RangeValidator _owner;
            ...
            public PropertyStateManagerRangeValidator(RangeValidator validator) : base(validator.BaseValidator)
            {
                _owner = validator;
            }
            ...
            protected override bool RequiresRerendering
            {
                get
                {
                    return base.RequiresRerendering ||
                           ValueHasChanged(_min, _owner.MinimumValue) ||
                           ValueHasChanged(_max, _owner.MaximumValue);
                }
            }
            ...
            protected override void AssignState(PropertyStateManagerControl source)
            {
                ...
                var stateManager = source as PropertyStateManagerRangeValidator;
                if (stateManager == null) return;

                _min = stateManager._min;
                _max = stateManager._max;
            }
            ...
            {
                _min = _owner.MinimumValue;
                _max = _owner.MaximumValue;
        ...
        {
            return new PropertyStateManagerRangeValidator(this);
        }
