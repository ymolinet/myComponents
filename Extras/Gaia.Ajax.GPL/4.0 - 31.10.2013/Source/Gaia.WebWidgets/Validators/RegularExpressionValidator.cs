...
namespace Gaia.WebWidgets
{
    ...
    /// </summary>
    [ToolboxBitmap(typeof(RegularExpressionValidator), "Resources.Gaia.WebWidgets.RegularExpressionValidator.bmp")]
    public class RegularExpressionValidator : ASP.RegularExpressionValidator, IAjaxControl, IAjaxValidator
    {
        /// <summary>
        /// Specialized <see cref="PropertyStateManagerControl"/> for <see cref="RegularExpressionValidator"/> control.
        /// </summary>
        public class PropertyStateManagerRegularExpressionValidator : PropertyStateManagerBaseValidator
        {
            private string _expression;
            private readonly RegularExpressionValidator _owner;
            ...
            public PropertyStateManagerRegularExpressionValidator(RegularExpressionValidator validator) : base(validator.BaseValidator)
            {
                _owner = validator;
            }
            ...
            {
                get { return base.RequiresRerendering || ValueHasChanged(_expression, _owner.ValidationExpression); }
            }
            ...
            protected override void AssignState(PropertyStateManagerControl source)
            {
                ...
                var stateManager = source as PropertyStateManagerRegularExpressionValidator;
                if (stateManager == null) return;

                _expression = stateManager._expression;
            }
            ...
            {
                _expression = _owner.ValidationExpression;
                base.TakeSnapshot();
            }
        }
        ...
        {
            return new PropertyStateManagerRegularExpressionValidator(this);
        }
