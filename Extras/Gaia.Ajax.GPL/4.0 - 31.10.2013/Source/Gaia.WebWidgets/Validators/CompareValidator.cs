...
namespace Gaia.WebWidgets
{
    ...
    /// </summary>
    [ToolboxBitmap(typeof(CompareValidator), "Resources.Gaia.WebWidgets.CompareValidator.bmp")]
    public class CompareValidator : ASP.CompareValidator, IAjaxControl, IAjaxValidator
    {
        /// <summary>
        /// Specialized <see cref="PropertyStateManagerControl"/> for <see cref="CompareValidator"/> control.
        /// </summary>
        public class PropertyStateManagerCompareValidator : PropertyStateManagerBaseCompareValidator
        {
            private ASP.CompareValidator _state;
            private readonly CompareValidator _owner;
            ...
            public PropertyStateManagerCompareValidator(CompareValidator validator) : base(validator.BaseValidator)
            {
                _owner = validator;
            }
            ...
            protected override bool RequiresRerendering
            {
                get
                {
                    return base.RequiresRerendering ||
                           ValueHasChanged(_owner.Operator, _state.Operator) ||
                           ValueHasChanged(_owner.ValueToCompare, _state.ValueToCompare) ||
                           ValueHasChanged(_owner.ControlToCompare, _state.ControlToCompare);
                }
            }
            ...
            protected override void AssignState(PropertyStateManagerControl source)
            {
                ...
                var stateManager = source as PropertyStateManagerCompareValidator;
            ...
            {
                _state = new ASP.CompareValidator
                             {
                                 Operator = _owner.Operator,
                                 ValueToCompare = _owner.ValueToCompare,
                                 ControlToCompare = _owner.ControlToCompare
                             };
        ...
        {
            return new PropertyStateManagerCompareValidator(this);
        }
