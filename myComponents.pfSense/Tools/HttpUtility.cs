...
namespace myComponents.pfSense
{
    ...
    internal static class HttpUtility
    {
        ...
        public static string HttpGetLoginPageContents(string url, CookieContainer cookieContainer, int timeout = 60000)
        {
            ...
            //if (request.ServicePoint.ConnectionName.ToLower() == "https")
        ...
        /// <returns>The website contents returned by the webserver after posting the data</returns>
        public static string DownloadBackupFile(string url, Dictionary<string, string> formFields, CookieContainer cookieContainer, int timeout = 60000, string referer = null)
        {
        ...
        /// <param name="timeout">Timeout in milliseconds on how long the request may take. Default = 60000 = 60 seconds.</param>
        /// <returns>The website contents returned by the webserver after posting the data</returns>
        public static string DownloadBackupFile(string url, string userName, string userPassword, Dictionary<string, string> formFields, CookieContainer cookieContainer, int timeout = 60000)
        {
            // Define the form separator to use in the POST request
            const string formDataBoundary = "---------------------------7dc1873b1609fa";
            ...
            catch (WebException wex)
            {
                ...
                {
                    throw new System.Exception("ERREUR: Identifiant ou mot de passe incorrect");
                }

                throw new System.Exception("ERREUR: {0}",wex);
            }
            catch (System.Exception ex)
            {
                throw new System.Exception("ERREUR: {0}", ex);
            }
