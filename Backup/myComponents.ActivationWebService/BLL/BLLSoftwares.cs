...
namespace myComponents.ActivationWebService.BLL
{
    ...
    public class BLLSoftwares
    {
        ...
        public Boolean Insert(String NomSoftware, Int32 Identifier)
        {
            try
            {
                String Commande = "INSERT INTO softwares (NAME, IDENTIFIER) VALUES ('" + NomSoftware + "'," + Identifier + ")";
                Connexion.Open();
