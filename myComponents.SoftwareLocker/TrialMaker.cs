...
namespace myComponents.SoftwareLocker
{
    // Activate Property
    public class TrialMaker
    {
        ...
        {
            _BaseString = myComponents.Crypto.Encryption.Boring(myComponents.Crypto.Encryption.InverseByBase(SystemInfo.GetSystemInfo(_SoftName), 10));
        }

        private void MakePassword()
        {
            _Password = myComponents.Crypto.Encryption.MakePassword(_BaseString, _Identifier);
        }
        ...
        public RunTypes ShowDialog()
        {
            ...
            Interfaces.frm.frmDialog PassDialog = new Interfaces.frm.frmDialog(_Identifier, _BaseString, _Password, DaysToEnd(), _Runed, _Text, _SoftName);
        ...
        private void MakeHideFile()
        {
            ...
            System.IO.File.SetAttributes(_HideFilePath, System.IO.FileAttributes.Hidden);
        }
